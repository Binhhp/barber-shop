...
<div class="app-title">
    <div>
        <h1><i class="fa fa-th-list"></i> Category blog</h1>
          <p>Table Category</p>
    </div>
    <ul class="app-breadcrumb breadcrumb side">
        <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
        <li class="breadcrumb-item">Blog</li>
        <li class="breadcrumb-item active"><a href="#">Category blog</a></li>
    </ul>
</div>
<div class="row">
    <div class="col-md-12">
            ...
            <form id="form-input" class="form-input" onsubmit="return false">
                <div class="modal-body">
                        ...
                        <div class="row form-group">
                            <label for="maduan" class="col-sm-3 text-right"><strong>Category Name</strong><span style="color:red;">*</span></label>
...
@endsection
@push('scripts')
<script src="{{ URL::to('jsAdmin/cate.js') }}"></script>
@endpush